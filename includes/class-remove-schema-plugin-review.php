...
if ( ! class_exists( 'Remove_Schema_Plugin_Review' ) ) :
  class Remove_Schema_Plugin_Review {
    ...
    */
    ...
    /**
    * Define the functionality of the class.
    */
    ...
    */
    public function display_admin_notice() {
      ...
      if ( isset( $screen->base ) && 'plugins' == $screen->base ) {
        ...
        <br /><br />
        <a class="button button-primary" href="' . esc_url( 'https://wordpress.org/support/view/plugin-reviews/' . $this->slug . '#postform' ) . '" target="_blank">' . __( 'Leave A Review', 'remove schema' ) . '</a>

        <a href="' . esc_url( $no_bug_url ) . '">' . __( 'No thanks.', 'remove-schema' ) . '</a>
        </p>
        </div>';
